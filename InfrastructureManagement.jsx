        ...
        <div className="min-h-screen p-4 md:p-8" style={{ background: 'var(--primary-bg)' }}>
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white">Enterprise Deployment Center</h1>
                        <p className="text-gray-300">Deploying Outpost Zero with IaC, Kubernetes, and CI/CD</p>
                    </div>
                </div>
                    ...
                    <TabsContent value="architecture" className="mt-6">
                        <Card className="bg-gray-800/50 border-gray-700">
                            ...
                            <CardContent>
                                ...
                                <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/d645ac1ea_diagram.png" alt="Architecture Diagram" className="rounded-lg border-2 border-blue-500/50" />
                                <ul className="mt-4 space-y-2 text-gray-300">
                                  <li className="flex items-center gap-2"><Shield className="w-4 h-4 text-green-400" /> <strong>IaC with Terraform:</strong> A single codebase to manage infrastructure across AWS, Azure, and GCP.</li>
                                  <li className="flex items-center gap-2"><HardDrive className="w-4 h-4 text-blue-400" /> <strong>Kubernetes Orchestration:</strong> Application components (API, AI Models, Workers) run as scalable, self-healing microservices.</li>
                                  <li className="flex items-center gap-2"><Zap className="w-4 h-4 text-yellow-400" /> <strong>CI/CD Automation:</strong> Code commits automatically trigger builds, tests, and deployments to Kubernetes, managed by GitHub Actions.</li>
                                </ul>
                            </CardContent>
                        </Card>
                    </TabsContent>
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: api-server
        image: cyberdojo/outpost-zero-api:latest # Replace with your image
        ports:
        - containerPort: 8080
...
kubectl apply -f api-service.yaml" description="Applies the configuration to your cluster." />
                    ...
                    <TabsContent value="cicd" className="mt-6">
                      ...
                      <Card className="bg-gray-800/50 border-gray-700">
                        ...
                        <CardContent>
                          <p className="mb-4">Create a file at `.github/workflows/deploy.yml` in your repository and add the following content.</p>
